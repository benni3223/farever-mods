...
| --- | --- | --- |
| General | Disable profanity filter; Hide UI keybinding | Profanity option on (imports previous preference); Hide UI defaults to F2 |
